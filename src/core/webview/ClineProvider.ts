	...
	*/
	...
	> {
		...
		return {
			...
			allowedMaxRequests: stateValues.allowedMaxRequests ?? null,
			allowedMaxCost: stateValues.allowedMaxCost ?? null,
			...
			terminalOutputPreviewSize: stateValues.terminalOutputPreviewSize ?? "medium",
