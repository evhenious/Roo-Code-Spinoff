...
export const useExtensionStateStore = create<IExtensionStoreWithMethods>((set, get) => {
  return {
    ...
    setAlwaysAllowModeSwitch: (value: boolean) => set((prevState) => ({ ...prevState, alwaysAllowModeSwitch: value })),
    ...
    setHasOpenedModeSelector: (value: boolean) => set((prevState) => ({ ...prevState, hasOpenedModeSelector: value })),
    ...
    setMaxDiagnosticMessages: (value: number) => set((prevState) => ({ ...prevState, maxDiagnosticMessages: value })),
