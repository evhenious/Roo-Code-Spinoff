...
CRITICAL: Do not use this tool until the user confirms previous tools succeeded. Failure causes broken code and incomplete work.

Parameters:
- result: (required) The short and clear summary of the completed task. Formulate this result in a way that is final and does not require further input from the user. Don't add questions or offers for further assistance in the end.
