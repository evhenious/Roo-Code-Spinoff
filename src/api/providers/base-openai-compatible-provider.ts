  ...
  implements SingleCompletionHandler
{
  ...
  protected createStream(
    ...
    const developerRoleMsg = convertToOpenAiMessages(messages, { useDeveloperRole: this.options.useDeveloperRole })

    const params: OpenAI.Chat.Completions.ChatCompletionCreateParamsStreaming = {
      model,
      max_tokens,
      temperature,
      messages: [{ role: "system", content: systemPrompt }, ...developerRoleMsg],
      stream: true,
