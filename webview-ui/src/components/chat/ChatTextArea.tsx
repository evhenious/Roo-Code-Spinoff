...
import { VolumeX, Image, SendHorizontal, X, ListEnd, Square } from "lucide-react"
  ...
  (
    ...
    useEffect(() => {
      const messageHandler = (event: MessageEvent) => {
        ...
        if (message.type === "insertTextIntoTextarea") {
          if (message.text && textAreaRef.current) {
            ...
            const newValue =
              currentValue.slice(0, cursorPos) + prefix + message.text + " " + currentValue.slice(cursorPos)
                ...
                <StandardTooltip content={t("chat:addImages")}>
                  <button
                    ...
                    className={cn(
                      ...
                      !shouldDisableImages && "hover:bg-[rgba(255,255,255,0.03)] hover:border-[rgba(255,255,255,0.15)]",
