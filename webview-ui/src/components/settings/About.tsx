...
import { Download, Upload, TriangleAlert, MessagesSquare } from "lucide-react"
...
export const About = ({ debug, setDebug, className, ...props }: AboutProps) => {
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)} {...props}>
      ...
      <Section className="space-y-0">
        <SearchableSetting settingId="about-manage-settings" section="about" label={t("settings:about.manageSettings")}>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="destructive" onClick={() => vscode.postMessage({ type: "resetState" })} className="w-28">
