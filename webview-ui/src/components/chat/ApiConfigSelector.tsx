      ...
      return (
        <div
          ...
          className={cn(
            ...
            isCurrentConfig &&
              "bg-amber-50 font-bold border-t border-b border-vscode-list-activeSelectionBackground/50",
          )}>
          <div className="flex-1 min-w-0 flex items-center gap-3 overflow-hidden">
            <span className="flex-shrink-0">{config.name}</span>
            {config.modelId && (
              <span
                className="text-vscode-descriptionForeground opacity-80 min-w-0 overflow-hidden"
          ...
          <div className="flex items-center gap-1">
            <StandardTooltip content={isPinned ? t("chat:unpin") : t("chat:pin")}>
              <Button
                ...
                className={cn("size-5 flex items-center justify-center -rotate-45", {
                  "opacity-0 group-hover:opacity-100": !isPinned && !isCurrentConfig,
                  "border border-gray-400/60 opacity-100": isPinned,
                })}>
