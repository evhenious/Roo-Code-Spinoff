...
const ModesView = () => {
  ...
  const handleSaveRenameMode = useCallback(() => {
    ...
    const nameTaken = modes.some((m) => m.name.toLowerCase() === trimmed.toLowerCase() && m.slug !== customMode.slug)
    if (nameTaken) {
  ...
  const handleAgentReset = (modeSlug: string, type: "roleDefinition" | "description" | "customInstructions") => {
      ...
      <Section>
        <div>
          <div onClick={(e) => e.stopPropagation()} className="flex justify-between items-center mb-3">
            <h3 className="text-[1.25em] font-semibold text-vscode-foreground mt-4 mb-2">{t("prompts:modes.title")}</h3>
            ...
            {isRenamingMode ? (
              ...
              <>
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      <div className="truncate">
                        {localRenames[visualMode] ?? getCurrentMode()?.name ?? t("prompts:modes.selectMode")}
                      </div>
                ...
                <StandardTooltip content={t("prompts:modes.createNewMode")}>
                  <Button variant="ghost" size="icon" onClick={openCreateModeDialog} data-testid="add-mode-button">
          ...
          <div className="mb-3">
            ...
            <div className="text-sm text-vscode-descriptionForeground mb-2">{t("prompts:apiConfiguration.select")}</div>
            <div className="mb-2">
              <Select
        ...
        <div className="mb-4">
          ...
          <div className="text-sm text-vscode-descriptionForeground mb-2">{t("prompts:description.description")}</div>
          <VSCodeTextField
            value={(() => {
              const customMode = findModeBySlug(visualMode, customModes)
              const prompt = customModePrompts?.[visualMode] as PromptComponent
            ...
            <div className="flex justify-between items-center mb-1">
              ...
              {findModeBySlug(visualMode, customModes) && (
                <StandardTooltip
                  ...
                  <Button variant="ghost" size="icon" onClick={() => setIsToolsEditMode(!isToolsEditMode)}>
          ...
          <div className="text-xs text-vscode-descriptionForeground mt-1.5">
            <Trans
              ...
              components={{
                ...
                "0": (
                  <VSCodeLink
                    href={buildDocLink("features/custom-instructions#setting-up-global-rules", "prompts_global_rules")}
                    style={{ display: "inline" }}
          ...
          <div className="w-[calc(100vw-100px)] h-full bg-vscode-editor-background shadow-md flex flex-col relative">
            <div className="flex-1 p-5 overflow-y-auto min-h-0">
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                />
                {roleDefinitionError && (
                  <div className="text-xs text-vscode-errorForeground mt-1">{roleDefinitionError}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <VSCodeTextField
                  ...
                  className="w-full"
                />
                {descriptionError && <div className="text-xs text-vscode-errorForeground mt-1">{descriptionError}</div>}
              </div>
                    ...
                    <VSCodeCheckbox
                      ...
                      onChange={(e: Event | React.FormEvent<HTMLElement>) => {
                        ...
                        if (checked) {
                          ...
                          setNewModeGroups(newModeGroups.filter((g) => getGroupName(g) !== group))
                        }
                      }}>
                      {t(`prompts:tools.toolNames.${group}`)}
                    </VSCodeCheckbox>
