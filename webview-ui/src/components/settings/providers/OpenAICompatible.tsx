...
export const OpenAICompatible = ({
  ...
  return (
    <>
      ...
      />
      <Checkbox
        checked={apiConfiguration?.useDeveloperRole ?? false}
        onChange={handleInputChange("useDeveloperRole", noTransform)}>
        {t("settings:modelInfo.useDeveloperRole")}
      </Checkbox>
      <R1FormatSetting
      ...
      <div className="mb-4">
        ...
        {!customHeaders.length ? (
          <div className="text-sm text-vscode-descriptionForeground">{t("settings:providers.noCustomHeaders")}</div>
        ) : (
      ...
      <div className="flex flex-col gap-3">
        ...
        <div>
          <div className="flex items-center gap-1">
            <Checkbox
              checked={
                apiConfiguration?.openAiCustomModelInfo?.supportsImages ?? openAiModelInfoSaneDefaults.supportsImages
              }
          ...
          <>
            <div>
              <VSCodeTextField
                ...
                className="w-full">
                <div className="flex items-center gap-1">
                  <span className="font-medium">{t("settings:providers.customModel.pricing.cacheReads.label")}</span>
                  <StandardTooltip content={t("settings:providers.customModel.pricing.cacheReads.description")}>
                    <i
            ...
            <div>
              <VSCodeTextField
                ...
                <div className="flex items-center gap-1">
                  ...
                  <StandardTooltip content={t("settings:providers.customModel.pricing.cacheWrites.description")}>
                    <i
                      className="codicon codicon-info text-vscode-descriptionForeground"
                      style={{ fontSize: "12px" }}
                    />
