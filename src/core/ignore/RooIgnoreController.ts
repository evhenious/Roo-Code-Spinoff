...
When using \`list_files\`, a ${LOCK_TEXT_SYMBOL} next to a file means this file is restricted to access. Attempting to access restricted files by tools e.g. through \`read_file\` will result in an error.`
  }
}
