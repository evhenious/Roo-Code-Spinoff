...
import { McpToolUse, ToolResponse, ToolUse } from "../../../shared/tools"
...
export async function handleMcpTool(taskInstance: Task, mcpBlock: McpToolUse) {
  ...
  // TODO remove as old not used even before ?
