...
describe("useMcpToolTool", () => {
  ...
  describe("parameter validation", () => {
    ...
    it("should handle invalid arguments type", async () => {
      ...
      expect(mockTask.consecutiveMistakeCount).toBe(1)
      expect(mockTask.recordToolError).toHaveBeenCalledWith("use_mcp_tool")
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("error", expect.stringContaining("invalid JSON argument"))
  ...
  describe("successful execution", () => {
    it("should execute tool successfully with valid parameters", async () => {
      ...
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_request_started")
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_response", "Tool executed successfully", [])
    ...
    it("should handle user rejection", async () => {
      ...
      expect(mockTask.renderUIMessage).not.toHaveBeenCalledWith("mcp_server_request_started")
      expect(mockAskApproval).toHaveBeenCalled()
  ...
  describe("error handling", () => {
    ...
    it("should reject unknown tool names", async () => {
      ...
      expect(mockTask.consecutiveMistakeCount).toBe(1)
      expect(mockTask.recordToolError).toHaveBeenCalledWith("use_mcp_tool")
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("error", expect.stringContaining("does not exist"))
    ...
    it("should reject unknown server names with available servers listed", async () => {
      ...
      expect(mockTask.consecutiveMistakeCount).toBe(1)
      expect(mockTask.recordToolError).toHaveBeenCalledWith("use_mcp_tool")
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("error", expect.stringContaining("not configured"))
  ...
  describe("image handling", () => {
    it("should handle tool response with image content", async () => {
      ...
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_request_started")
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_response", "[1 image(s) received]", [
    ...
    it("should handle tool response with both text and image content", async () => {
      ...
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_request_started")
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_response", "Node name: Button", [
    ...
    it("should handle multiple images in response", async () => {
      ...
      expect(mockTask.renderUIMessage).toHaveBeenCalledWith("mcp_server_response", "[2 image(s) received]", [
