...
/**
 * This is the handler for 'OpenAI Compatible' selection in Provider type dropdown in Settings
 */
  ...
  override async *createMessage(
    ...
    if (this.options.openAiStreamingEnabled ?? true) {
      ...
      if (deepseekReasoner) {
        ...
        convertedMessages = [
          systemMessage,
          ...convertToOpenAiMessages(messages, { useDeveloperRole: this.options.useDeveloperRole }),
        ]
      ...
      const requestOptions: OpenAI.Chat.Completions.ChatCompletionCreateParamsNonStreaming = {
        ...
        messages: deepseekReasoner
          ...
          : [systemMessage, ...convertToOpenAiMessages(messages, { useDeveloperRole: this.options.useDeveloperRole })],
