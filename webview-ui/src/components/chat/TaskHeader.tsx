...
const TaskHeader = ({
  ...
  const condenseButton = (
    <LucideIconButton
      ...
      icon={FoldVertical}
      className={buttonsDisabled ? "" : "hover:text-blue-600"}
                    ...
                    return (
                      <>
                        <CircularProgress
                          ...
                          className={percentage > 50 ? "text-yellow-500" : percentage > 75 ? "text-orange-500" : ""}
                        />
                        <span
                          className={percentage > 50 ? "text-yellow-600" : percentage > 75 ? "text-orange-600" : ""}>
                          {percentage}%
                        </span>
                      </>
                    )
