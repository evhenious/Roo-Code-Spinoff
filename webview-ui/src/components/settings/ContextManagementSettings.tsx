    ...
    <div className={cn("flex flex-col gap-2", className)} {...props}>
      ...
      <Section>
        ...
        <SearchableSetting
          ...
          <span className="block font-medium mb-1">{t("settings:contextManagement.maxGitStatusFiles.label")}</span>
          <div className="flex items-center gap-2">
            <Slider
              min={0}
              max={50}
        ...
        <SearchableSetting
          ...
          <VSCodeCheckbox
            ...
            <label className="block font-medium mb-1">{t("settings:contextManagement.rooignore.label")}</label>
          </VSCodeCheckbox>
        ...
        <SearchableSetting
          ...
          <div className="flex items-center gap-2">
            <Slider
              ...
              step={1}
              value={[
                maxDiagnosticMessages !== undefined && maxDiagnosticMessages <= 0 ? 100 : (maxDiagnosticMessages ?? 50),
              ]}
              onValueChange={([value]) => {
        ...
        <SearchableSetting
          ...
          <VSCodeCheckbox
            ...
            <label className="block font-medium mb-1">{t("settings:contextManagement.includeCurrentTime.label")}</label>
          </VSCodeCheckbox>
          <div className="text-vscode-descriptionForeground text-sm mt-1 mb-3">
